...
class CreateMarsRover(private val repository: MarsRoverRepository): ApplicationService<CreateMarsRoverCommand> {

    override fun execute(command: CreateMarsRoverCommand) {
